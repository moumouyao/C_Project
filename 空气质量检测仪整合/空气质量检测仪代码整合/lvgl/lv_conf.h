...
/*	屏幕分辨率	*/
#define LV_HOR_RES_MAX          (320)	//水平最大值
#define LV_VER_RES_MAX          (240)	//竖直最大值
...
#define LV_DISP_ROT_MAX_BUF  (15U * 1024U)
...
#if LV_MEM_CUSTOM == 0
/* Size of the memory used by `lv_mem_alloc` in bytes (>= 2kB)*/	//空间大小
#  define LV_MEM_SIZE    (20U * 1024U)	//内存空间	20k
...
#define LV_USE_API_EXTENSION_V6  0	//版本
