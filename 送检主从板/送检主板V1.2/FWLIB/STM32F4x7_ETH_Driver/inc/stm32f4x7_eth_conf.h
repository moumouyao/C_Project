...
//LAN8720 PHY芯片的状态寄存器
#define PHY_SR				((uint16_t)16) 		//LAN8720的PHY状态寄存器地址31  DP83848的状态寄存器是16
#define PHY_SPEED_STATUS    ((uint16_t)0x0002) 	//LAN8720 PHY速度值掩码是4   DP83848是2
#define PHY_DUPLEX_STATUS   ((uint16_t)0x0004) //LAN8720 PHY连接状态值掩码是10  DP83848的是4 
#endif 
