...
#define OS_EVENT_NAME_EN          1u   /* 使能给信号量,互斥信号量,消息队列的命名Enable names for Sem, Mutex, Mbox and Q                      */
...
#define OS_MAX_MEM_PART          10u   /*内存块数目 Max. number of memory partitions                             5*/
#define OS_MAX_QS                20u   /* 最大队列控制块数Max. number of queue control blocks in your application      */
#define OS_MAX_TASKS             10u   /* 最大的任务数量Max. number of tasks in your application, MUST be >= 2       */

#define OS_SCHED_LOCK_EN          1u   /* Include code for OSSchedLock() and OSSchedUnlock()           */

#define OS_TICK_STEP_EN           1u   /* Enable tick stepping feature for uC/OS-View                  */
#define OS_TICKS_PER_SEC       	1000u   /* 设置1s时间的节拍数 Set the number of ticks in one second                        */
